...
import { Archive, ArrowLeft, Camera, ImagePlus, LoaderCircle, LocateFixed, LogOut, MapPin, PackageOpen, Pencil, Plus, Search, Sparkles, Trash2, X } from 'lucide-react'
import './App.css'
...
function ItemDetail({ item, token, onBack, onEdit, onDelete }: { item: Item; token: string; onBack: () => void; onEdit: () => void; onDelete: () => void }) {
